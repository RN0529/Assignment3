              ...
              <ul>
                {
                  this.state.debits
                    .map(debits =>
                      <li style={{listStylePosition: "inside"}} key={debits.id}>{debits.date.slice(0,10)} |{debits.description} | {debits.amount} </li>
                    )
                }
              </ul>
            </div>
            ...
            <ul>
              {
                this.state.credit
                  .map(credit =>
                    ...
                    <li style={{listStylePosition: "inside"}} key={credit.id}>{credit.date.slice(0,10)} | {credit.description} | {credit.amount} </li>
                  )
              }
            </ul>
          </div>
